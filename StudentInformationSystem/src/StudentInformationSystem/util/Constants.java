...
public class Constants {
	...
	public static final String URL = "jdbc:mysql://127.0.0.1:3306/db_sis?autoReconnect=true&useSSL=false&characterEncoding=UTF-8";
	...
	public static final String FORMAT_SUBJECTCODE = "[A-Z]{2,3}[0-9]{5}";
