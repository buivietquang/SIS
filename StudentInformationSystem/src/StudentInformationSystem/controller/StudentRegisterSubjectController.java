...
public class StudentRegisterSubjectController implements Initializable {
	...
	SemesterList = FXCollections.observableArrayList("20221", "20222", "20231", "20232","20241");
	...
	protected void completeRegister() throws ClassNotFoundException, SQLException {
		...
		if (alert.getResult() == ButtonType.OK) {
			...
			beforeDeleteList = registerSubjectLogic.getRegisterSubject(userInfo.getIdStudent(), "20232");
